...
export class HostedApi extends runtime.BaseAPI {
   ...
   */
  async getHostedCombinedSessionsRaw(
    requestParameters: GetHostedCombinedSessionsRequest,
  ...
  async getHostedCombinedSessions(
    ...
    const response = await this.getHostedCombinedSessionsRaw(
      requestParameters,
      initOverrides,
    );
