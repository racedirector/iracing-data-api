 ...
 */
export function instanceOfIracingServiceMethodDocs(
  value: object,
...
export function IracingServiceMethodDocsFromJSON(
  json: any,
): IracingServiceMethodDocs {
  return IracingServiceMethodDocsFromJSONTyped(json, false);
}

export function IracingServiceMethodDocsFromJSONTyped(
  json: any,
...
export function IracingServiceMethodDocsToJSON(
  json: any,
): IracingServiceMethodDocs {
  return IracingServiceMethodDocsToJSONTyped(json, false);
}

export function IracingServiceMethodDocsToJSONTyped(
  value?: IracingServiceMethodDocs | null,
