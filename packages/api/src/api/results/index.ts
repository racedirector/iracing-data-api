...
import { CategoryIdValue, EventTypeValue } from "../../types";
...
export class ResultsAPI {
  ...
  get({
    ...
    return this._client.get("/data/results/get", {
      params: {
  ...
  eventLog({
    ...
    return this._client.get("/data/results/event_log", {
      params: {
        subsession_id: subsessionId,
  ...
  lapChartData({
    ...
    return this._client.get("/data/results/lap_chart_data", {
      params: {
        subsession_id: subsessionId,
        simsession_number: simsessionNumber,
      },
  ...
  lapData({
    ...
    return this._client.get("/data/results/lap_data", {
      params: {
        subsession_id: subsessionId,
        simsession_number: simsessionNumber,
        cust_id: customerId,
  ...
  searchHosted({
    ...
    return this._client.get("/data/results/search_hosted", {
      params: {
  ...
  searchSeries({
    ...
    return this._client.get("/data/results/search_series", {
      params: {
  ...
  seasonResults({
    ...
    return this._client.get("/data/results/season_results", {
      params: {
        season_id: seasonId,
