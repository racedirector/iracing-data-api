...
export class LeagueAPI {
  ...
  directory({
    ...
    return this._client.get("/data/league/directory", {
      params: {
        search,
        tag,
  ...
  get({
    ...
    return this._client.get("/data/league/get", {
  ...
  getPointsSystems({
    ...
    return this._client.get("/data/league/get_points_systems", {
  ...
  membership({
    ...
    return this._client.get("/data/league/membership", {
  ...
  roster({
    ...
    return this._client.get("/data/league/roster", {
      params: { league_id: leagueId, include_licenses: includeLicenses },
    });
  }

  seasons({ leagueId, retired }: { leagueId: number; retired?: boolean }) {
    return this._client.get("/data/league/seasons", {
  ...
  seasonStandings({
    ...
    return this._client.get("/data/league/season_standings", {
      params: {
        league_id: leagueId,
        season_id: seasonId,
  ...
  seasonSessions({
    ...
    return this._client.get("/data/league/season_sessions", {
      params: {
        league_id: leagueId,
        season_id: seasonId,
