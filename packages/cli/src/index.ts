...
import { syncCarAssets as downloadCarAssets } from "@iracing-data/sync-car-assets";
import { syncTrackAssets as downloadTrackAssets } from "@iracing-data/sync-track-assets";
